classdef complAHRS< handle
    ...
    methods (Access = public)
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            Gyroscope = Gyroscope + obj.eProp_RP + obj.eInt_RP + obj.eProp_Yaw + obj.eInt_Yaw;
            ...
            %% PI controller
            obj.eProp_Yaw = obj.Kp_Yaw * eYaw + eP_Yaw;
            obj.eInt_Yaw = obj.Ki_Yaw * eYaw + eI_Yaw;           
            
            obj.eProp_RP = eP_RP; %obj.Kp_RP * eRollPitch + eP_RP;
            obj.eInt_RP = eI_RP; %obj.Ki_RP * eRollPitch + eI_RP;
